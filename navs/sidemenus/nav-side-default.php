    ...
    <div class="sidebar-wrapper" style="height: calc(100vh - 180px); overflow-y: auto; padding-bottom: 80px;">
        <nav class="nav-menu h-100 d-flex flex-column">
            <ul class="nav sidebar-menu flex-column flex-grow-1" data-lte-toggle="treeview" role="menu">
                <!-- Character Section -->
                <li id="character-anchor"
                    class="nav-item <?php echo ($currentSub === 'character' || $currentSub === 'inventory') ? 'menu-open' : ''; ?>">
                    ...
                    <ul id="character-list" class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="/game?page=profile&sub=character"
                                class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'profile' && $currentSub === 'character') ? 'active' : ''; ?>">
                        ...
                        <li class="nav-item">
                            <a href="/game?page=sheet&sub=character"
                                class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'sheet' && $currentSub === 'character') ? 'active' : ''; ?>">
                        ...
                        <li id="inventory-anchor" class="nav-item">
                            <a href="#" class="nav-link d-flex align-items-center ps-3">
                                ...
                                <ul id="inventory-list" class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="/game?page=equipment&sub=inventory"
                                            class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'equipment' && $currentSub === 'inventory') ? 'active' : ''; ?>">
                                    ...
                                    <li id="items-anchor" class="nav-item">
                                        ...
                                        <ul id="items-list" class="nav nav-treeview">
                                            <li class="nav-item">
                                                <a href="/game?page=quest&sub=items"
                                                    class="nav-link d-flex align-items-center ps-5 <?php echo ($currentPage === 'quest' && $currentSub === 'items') ? 'active' : ''; ?>">
                                                    <i
                                                        class="nav-icon material-symbols-outlined">deployed_code_alert</i>
                                                    <p class="ms-2">Quest Items</p>
                                                </a>
                                            </li>

                                            <li class="nav-item">
                                                <a href="/game?page=consumables&sub=items"
                                                    class="nav-link d-flex align-items-center ps-5 <?php echo ($currentPage === 'consumables' && $currentSub === 'items') ? 'active' : ''; ?>">
                        ...
                        <li class="nav-item">
                            <a href="/game?page=skills&sub=character"
                                class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'skills' && $currentSub === 'character') ? 'active' : ''; ?>">
                        ...
                        <li class="nav-item">
                            <a href="/game?page=spells&sub=character"
                                class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'spells' && $currentSub === 'character') ? 'active' : ''; ?>">
                        ...
                        <li class="nav-item">
                            <a href="/game?page=train&sub=character"
                                class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'train' && $currentSub === 'character') ? 'active' : ''; ?>">
            ...
            <li id="familiar-anchor" class="nav-item <?php echo ($currentSub === 'familiar') ? 'menu-open' : ''; ?>">
                ...
                <ul id="familiar-list" class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="/game?page=manage&sub=familiar"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'manage' && $currentSub === 'familiar') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="/game?page=hatchery&sub=familiar"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'hatchery' && $currentSub === 'familiar') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="/game?page=equipment&sub=familiar"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'equipment' && $currentSub === 'familiar') ? 'active' : ''; ?>">
            ...
            <li id="location-anchor" class="nav-item <?php echo ($currentSub === 'location') ? 'menu-open' : ''; ?>">
                ...
                <ul id="location-list" class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="/game?page=hunt&sub=location"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'hunt' && $currentSub === 'location') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="/game?page=map&sub=location"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'map' && $currentSub === 'location') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="/game?page=explore&sub=location"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'explore' && $currentSub === 'location') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="/game?page=zone&sub=location"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'zone' && $currentSub === 'location') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="/game?page=rest&sub=location"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'rest' && $currentSub === 'location') ? 'active' : ''; ?>">
            ...
            <li id="economy-anchor"
                class="nav-item <?php echo ($currentSub === 'economy' || $currentSub === 'blackmarket' || $currentSub === 'bank') ? 'menu-open' : ''; ?>">
                <a href="#" class="nav-link d-flex align-items-center ps-2">
                ...
                <ul id="economy-list" class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="/game?page=equipment&sub=economy"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'equipment' && $currentSub === 'economy') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="/game?page=items&sub=economy"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'items' && $currentSub === 'economy') ? 'active' : ''; ?>">
                            <i class="nav-icon material-symbols-outlined">diamond</i>
                            <p class="ms-2">Items</p>
                        </a>
                    </li>

                    <li id="blackmarket-anchor"
                        class="nav-item <?php echo ($currentSub === 'blackmarket') ? 'menu-open' : ''; ?>">
                        <a href="#" class="nav-link d-flex align-items-center ps-3">
                        ...
                        <ul id="blackmarket-list" class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/game?page=buy&sub=blackmarket"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'buy' && $currentSub === 'blackmarket') ? 'active' : ''; ?>">
                            ...
                            <li class="nav-item">
                                <a href="/game?page=sell&sub=blackmarket"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'sell' && $currentSub === 'blackmarket') ? 'active' : ''; ?>">
                            ...
                            <li class="nav-item">
                                <a href="/game?page=market&sub=blackmarket"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'market' && $currentSub === 'blackmarket') ? 'active' : ''; ?>">
                    ...
                    <li id="bank-anchor" class="nav-item <?php echo ($currentSub === 'bank') ? 'menu-open' : ''; ?>">
                        ...
                        <ul id="bank-list" class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/game?page=account&sub=bank"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'account' && $currentSub === 'bank') ? 'active' : ''; ?>">
                            ...
                            <li class="nav-item">
                                <a href="/game?page=loans&sub=bank"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'loans' && $currentSub === 'bank') ? 'active' : ''; ?>">
            ...
            <li id="dungeon-anchor" class="nav-item <?php echo ($currentSub === 'dungeon') ? 'menu-open' : ''; ?>">
                ...
                <ul id="dungeon-list" class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="/game?page=dungeon&sub=dungeon"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'dungeon' && $currentSub === 'dungeon') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="/game?page=settings&sub=dungeon"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'settings' && $currentSub === 'dungeon') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="/game?page=reset&sub=dungeon"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'reset' && $currentSub === 'dungeon') ? 'active' : ''; ?>">
            ...
            <li id="quests-anchor" class="nav-item <?php echo ($currentSub === 'quests') ? 'menu-open' : ''; ?>">
                ...
                <ul id="quest-list" class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="/game?page=intro&sub=quests"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'active' && $currentSub === 'quests') ? 'active' : ''; ?>"
                            disabled>
                    ...
                    <li class="nav-item">
                        <a href="/game?page=active&sub=quests"
                            class="nav-link text-secondary d-flex align-items-center ps-3 <?php echo ($currentPage === 'active' && $currentSub === 'quests') ? 'active' : ''; ?> disabled"
                            disabled>
                    ...
                    <li class="nav-item">
                        <a href="/game?page=accepted&sub=quests"
                            class="nav-link text-secondary d-flex align-items-center ps-3 <?php echo ($currentPage === 'accepted' && $currentSub === 'quests') ? 'active' : ''; ?> disabled"
                            disabled>
                    ...
                    <li class="nav-item">
                        <a href="/game?page=completed&sub=quests"
                            class="nav-link text-secondary d-flex align-items-center ps-3 <?php echo ($currentPage === 'completed' && $currentSub === 'quests') ? 'active' : ''; ?> disabled"
                            disabled>
                    ...
                    <li class="nav-item">
                        <a href="/game?page=abandoned&sub=quests"
                            class="nav-link text-secondary d-flex align-items-center ps-3 <?php echo ($currentPage === 'abandoned' && $currentSub === 'quests') ? 'active' : ''; ?> disabled"
                            disabled>
            ...
            <li id="mail-anchor"
                class="nav-item <?php echo ($currentSub === 'mail' || $currentSub === 'folders') ? 'menu-open' : ''; ?>">
                <a href="#" class="nav-link d-flex align-items-center ps-2">
                ...
                <ul id="mail-list" class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="/game?page=compose&sub=mail"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'compose' && $currentSub === 'mail') ? 'active' : ''; ?>">
                    ...
                    <li id="folder-anchor"
                        class="nav-item <?php echo ($currentSub === 'folders') ? 'menu-open' : ''; ?>">
                        <a href="#" class="nav-link d-flex align-items-center ps-3">
                        ...
                        <ul id="folder-list" class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/game?page=inbox&sub=folders"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'inbox' && $currentSub === 'folders') ? 'active' : ''; ?>">
                                    <i class="nav-icon material-symbols-outlined">inbox</i>
                                    <p class="ms-2">Inbox</p>
                                    <?php if ($folders['INBOX']): ?>
                                        <span
                                            class="nav-badge badge text-bg-danger ms-auto me-3"><?php echo $folders['INBOX']; ?></span>
                                    <?php else: ?>
                            ...
                            <li class="nav-item">
                                <a href="/game?page=outbox&sub=folders"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'outbox' && $currentSub === 'folders') ? 'active' : ''; ?>">
                                    <i class="nav-icon material-symbols-outlined">outbox</i>
                                    <p class="ms-2">Outbox</p>
                                    <?php if ($folders['OUTBOX']): ?>
                                        <span
                                            class="nav-badge badge text-bg-danger ms-auto me-3"><?php echo $folders['OUTBOX']; ?></span>
                                    <?php else: ?>
                                        <span class="nav-badge badge text-bg-secondary ms-auto me-3">0</span>
                                    <?php endif; ?>
                                </a>
                            ...
                            <li class="nav-item">
                                <a href="/game?page=deleted&sub=folders"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'deleted' && $currentSub === 'folders') ? 'active' : ''; ?>">
                                    <i class="nav-icon material-symbols-outlined">cancel_presentation</i>
                                    <p class="ms-2">Deleted</p>
                                    <?php if ($folders['DELETED']): ?>
                                        <span
                                            class="nav-badge badge text-bg-danger ms-auto me-3"><?php echo $folders['DELETED']; ?></span>
                                    <?php else: ?>
                                        <span class="nav-badge badge text-bg-secondary ms-auto me-3">0</span>
                                    <?php endif; ?>
                                </a>
                            ...
                            <li class="nav-item">
                                <a href="/game?page=drafts&sub=folders"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'drafts' && $currentSub === 'folders') ? 'active' : ''; ?>">
                                    <i class="nav-icon material-symbols-outlined">mark_as_unread</i>
                                    <p class="ms-2">Drafts</p>
                                    <?php if ($folders['DRAFTS']): ?>
                                        <span
                                            class="nav-badge badge text-bg-danger ms-auto me-3"><?php echo $folders['DRAFTS']; ?></span>
                                    <?php else: ?>
                                        <span class="nav-badge badge text-bg-secondary ms-auto me-3">0</span>
                                    <?php endif; ?>
                                </a>
                    ...
                    <li class="nav-item">
                        <a href="/game?page=settings&sub=mail"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'settings' && $currentSub === 'mail') ? 'active' : ''; ?>">
            ...
            <li id="account-anchor"
                class="nav-item <?php echo ($currentSub === 'account' || $currentSub === 'friends') ? 'menu-open' : ''; ?>">
                <a href="#" class="nav-link d-flex align-items-center ps-2">
                ...
                <ul id="account-list" class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="/game?page=profile&sub=account"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'profile' && $currentSub === 'account') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="/game?page=awards&sub=account"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'awards' && $currentSub === 'account') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="/game?page=achievements&sub=account"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'achievements' && $currentSub === 'account') ? 'active' : ''; ?>">
                            <i class="nav-icon material-symbols-outlined">military_tech</i>
                            <p class="ms-2">Achievements</p>
                        </a>
                    </li>

                    <li id="friends-anchor"
                        class="nav-item <?php echo ($currentSub === 'friends') ? 'menu-open' : ''; ?>">
                        <a href="#" class="nav-link d-flex align-items-center ps-3">
                        ...
                        <ul id="friends-list" class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/game?page=mutual&sub=friends"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'mutual' && $currentSub === 'friends') ? 'active' : ''; ?>">
                            ...
                            <li class="nav-item">
                                <a href="/game?page=requested&sub=friends"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'requested' && $currentSub === 'friends') ? 'active' : ''; ?>">
                            ...
                            <li class="nav-item">
                                <a href="/game?page=requests&sub=friends"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'requests' && $currentSub === 'friends') ? 'active' : ''; ?>">
                            ...
                            <li class="nav-item">
                                <a href="/game?page=blocked&sub=friends"
                                    class="nav-link d-flex align-items-center ps-4 <?php echo ($currentPage === 'blocked' && $currentSub === 'friends') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item mb-3">
                        <a href="/game?page=settings&sub=account"
                            class="nav-link d-flex align-items-center ps-3 <?php echo ($currentPage === 'settings' && $currentSub === 'account') ? 'active' : ''; ?>">
                ...
                <div id="bottom-menu" name="bottom-menu"
                    class="d-flex align-items-center ms-3 pb-3 position-absolute bottom-0 ms-3 ps-3 start-0 w-100 bg-dark mb-3"
                    style="z-index: 1030; min-height: 70px;">
                    <a href="#offcanvas-summary" class="d-flex align-items-center text-decoration-none"
                        id="dropdownUser1" data-bs-toggle="offcanvas" aria-expanded="false" role="button"
                        aria-controls="offcanvas-summary">
                        <span><img src="img/avatars/<?php echo $character->get_avatar(); ?>" alt="avatar" width="50"
                    ...
                    <ul class="dropdown-menu dropdown-menu text-small shadow">
                        ...
                        <li>
                            <a class="dropdown-item" href="?page=mail">Mail
                                ...
                                ?>
                                <span class="badge <?php echo $pill_bg; ?> rounded-pill">
                                    <?php echo $unread_mail; ?></span>
                            </a>
                        </li>
                        <li>
...
<div id="sidebar-sliver" class="text-center"
    style="position: fixed; left: 0; top: 0; width: 10px; height: 100vh; z-index: 999; cursor: pointer; display: none;"
    onclick="document.querySelector('#terst').classList.remove('sidebar-collapse'); document.querySelector('#terst').classList.add('sidebar-open');">
    &gt;</div>
