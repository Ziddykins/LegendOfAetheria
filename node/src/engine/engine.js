...
import { buildCombatStack, createDialogueCore, traversalCore, statusCore, } from '@ai-rpg-engine/modules';
...
let dialogueMap = Object.fromEntries(dialogueDefinitions.map(d => [d.id, d]));
