<?php
        $filename = __DIR__ . '/img/generated/spooky/124157157123160157157153171064115145.gif';
?>


<script>
let eles = document.querySelectorAll('div').forEach(function(e) {    
...
<script type="text/javascript" src="js/spooky.js"></script>
    ...
    <div class="glitch__container">
        <div class="glitch__text">
            ...
            <h1 class="glitch__text__title glitch-effect">
                ...
                <span class="glitch-effect-text-clr2">
                    <img src='img/generated/spooky/124157157123160157157153171064115145.gif' />
                </span>
            </h1>
        </div>
