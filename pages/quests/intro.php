...
$data = ['targetIds' => 1];
$endpoint = "v1/talk/$quest_npc";
$state = ai_serv_post('v1/state');
...
if (isset($_GET['choiceIndex']) && $_GET['choiceIndex'] != null) {
    ...
    $endpoint = "v1/talk/{$dialogue->npcId}/{$dialogue->activeNodeId}";
    $data = [
            ...
            <div class="row g-0 align-items-stretch">
                <div class="col-lg-4">
                    <div class="quest-avatar-wrapper d-flex align-items-center justify-content-center p-3">
                        <img class="img-fluid rounded-4 quest-avatar" src="/img/avatars/npc/question-sage.jpg"
                            alt="Quest Giver" />
                    </div>
                </div>
                    ...
                    <div class="card-body p-5 position-relative">
                        <div
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted small mb-0">A mysterious sage offers guidance from the forgotten
                                    archives.</p>
                                <span
                                    class="badge rounded-pill bg-warning-subtle text-warning border border-warning-subtle">New
                                    Encounter</span>
                            </div>
                        </div>
                    ...
                    <div class="quest-choices row g-3">
                        <?php foreach ($message->choices as $idx => $choice): ?>
                            ...
                            <div class="col-12">
                                ...
                                class="quest-choice d-flex align-items-center p-3 rounded-4 text-decoration-none">
